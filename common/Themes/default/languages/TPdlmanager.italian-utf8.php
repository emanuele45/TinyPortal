...
$txt['tp-authorID'] = 'Autore';
$txt['tp-created'] = 'Creato';
$txt['tp-dladmin'] = 'Amministrazione';
$txt['tp-dldownloads'] = 'Download';
$txt['tp-dlexterror'] = 'Al momento è possibile caricare file solo in questi formati';
$txt['tp-dlexterror2'] = 'Il tuo file era';
$txt['tp-dlftp'] = 'FTP';
...
$txt['tp-dlheader3'] = 'Gestisci categorie ed oggetti nel modulo di gestione dei Download';
$txt['tp-dlmaxerror'] = 'La massima dimensione per un file caricato è attualmente';
$txt['tp-dlmaxerror2'] = 'Il tuo file era';
$txt['tp-dlsubmissions'] = 'invii';
$txt['tp-dltabs1'] = 'Impostazioni';
$txt['tp-dltabs2'] = 'Aggiungi categoria';
$txt['tp-dltabs3'] = 'Carica';
...
$txt['tp-id'] = 'ID';
$txt['tp-last_access'] = 'Ultimo accesso';
$txt['tp-mainpage'] = 'Principale';
$txt['tp-name']='Nome:';
$txt['tp-needtoregister'] = 'Devi essere registrato per entrare in questa sezione.';
$txt['tp-notallowed'] = 'Non sei autorizzato ad accedere a questa sezione.';
$txt['tp-notfound'] = 'L\'oggetto/sezione non sono stati trovati.';
$txt['tp-sortby'] = 'Ordina per';
$txt['tp-useredit'] = 'Modifica file';
